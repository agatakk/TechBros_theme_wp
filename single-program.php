                ...
                if($relatedPeople){
                    foreach($relatedPeople as $person) {?>
                        ...
                        <div class="authors__name authors-about__name">
                            <h4 class="authors-about__title"><a href="<?php echo get_the_permalink()?>"> <?php echo get_the_title($person);?></a></h4>
                            <p class="authors-about__email"><?php echo get_field('email_address')?></p>
                        </div>
